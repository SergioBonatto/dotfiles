...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  if &background ==# 'dark'
    ...
    let s:hue_3  = ['#be4cdf', '176'] " purple
    let s:hue_4  = ['#42f032', '114'] " green

    let s:hue_5   = ['#f03269', '168'] " red 1
    let s:hue_5_2 = ['#b12850', '130'] " red 2

    let s:hue_6   = ['#f0ea32', '173'] " orange 1
    let s:hue_6_2 = ['#f08b32', '180'] " orange 2

    let s:syntax_bg     = ['#2a2e33', '16']
    let s:syntax_gutter = ['#636d83', '60']
    let s:syntax_cursor = ['#2c323c', '16']

    let s:syntax_accent = ['#0083be', '69']
    let s:syntax_accent_2 = ['#cb7ffa', '63']
    ...
    let s:hue_4  = ['#32f04f', '71'] " green

    let s:hue_5   = ['#f03269', '166'] " red 1
    let s:hue_5_2 = ['#ca1243', '160'] " red 2

    let s:hue_6   = ['#f0ea32', '94'] " orange 1
    let s:hue_6_2 = ['#f08b32', '136'] " orange 2
  ...
  call <sid>X('String',         s:hue_6_2,         '',          '')
  call <sid>X('Character',      s:hue_4,         '',          '')
  call <sid>X('Number',         s:hue_5_2,         '',          '')
  call <sid>X('Boolean',        s:hue_1,         '',          'italic')
  call <sid>X('Float',          s:hue_6,         '',          '')
  call <sid>X('Identifier',     s:hue_5,         '',          'none')
  call <sid>X('Function',       s:hue_4,         '',          '')
  ...
  call <sid>X('Type',           s:syntax_accent_2,       '',          '')
  call <sid>X('StorageClass',   s:hue_6_2,       '',          '')
  call <sid>X('Structure',      s:hue_6_2,       '',          '')
  call <sid>X('Typedef',        s:syntax_accent_2,       '',          '')
  call <sid>X('Special',        s:hue_2,         '',          '')
